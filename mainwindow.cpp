...
void MainWindow::paintGL()
{
    ...
    qglColor(Qt::white);
    QGLWidget::renderText(10, 10 , 0, QString::fromUtf8("Вы набрали %1 очков:").arg(point), QFont());
...
{
    glBegin(GL_POLYGON);
        glColor3f(1,1,0.9);// Цвет выделенной области
        // Координаты выделенной области
        glVertex2f(gdx, gdy);
...
{
    glBegin(GL_POLYGON);
        glColor3f(0,1,1);// Цвет выделенной области
        // Координаты выделенной области
        glVertex2f(100, 100);
        glVertex2f(300, 100);
        glVertex2f(300, 300);
